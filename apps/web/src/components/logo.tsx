    ...
    >
      ...
      <div
        className={cn(
          ...
          "border border-dashed border-white/20 bg-white/10 shadow-lg shadow-black/20 backdrop-blur-xs",
        )}
        style={{
          width: size,
          height: size,
      ...
      <div
        className={cn(
          "absolute rounded-full",
          "border border-dashed border-white/70 bg-black/20 shadow-lg shadow-black/20 backdrop-blur-xs",
        )}
        style={{
          width: size,
          height: size,
